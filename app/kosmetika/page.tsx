...
<section className="lux-hero"><div className="lux-hero-copy"><p className="lux-kicker">Kosmetika · Plzeň</p><h1>Péče, která je<br/><em>vidět i cítit.</em></h1><p>Individuální kosmetická péče, relaxační procedury a chvíle klidu zaměřená na svěží vzhled a dobrý pocit.</p><div className="lux-actions"><a className="lux-btn primary" href="#objednani">Objednat se</a><a className="lux-btn secondary" href="tel:+420603100425">Zavolat kosmetičce</a></div></div><div className="lux-visual" aria-hidden="true" style={{backgroundImage:"linear-gradient(120deg, rgba(44,28,22,.04), rgba(44,28,22,.18)), url('https://images.unsplash.com/photo-1761718209793-cb6d348831e0?auto=format&fit=crop&w=1800&q=88')",backgroundSize:"cover",backgroundPosition:"center 58%"}}><div className="visual-frame" style={{background:"linear-gradient(160deg,rgba(255,255,255,.18),rgba(255,255,255,.02))",backdropFilter:"blur(2px)"}}><span>SKIN</span><strong>YOUR<br/>MOMENT</strong></div></div></section>
