...
<section className="lux-hero"><div className="lux-hero-copy"><p className="lux-kicker">Kosmetika · Plzeň</p><h1>Péče, která je<br/><em>vidět i cítit.</em></h1><p>Individuální kosmetická péče, relaxační procedury a chvíle klidu zaměřená na svěží vzhled a dobrý pocit.</p><div className="lux-actions"><a className="lux-btn primary" href="#objednani">Objednat se</a><a className="lux-btn secondary" href="tel:+420603100425">Zavolat kosmetičce</a></div></div><div className="lux-visual" aria-hidden="true"><div className="visual-glow"/><div className="visual-frame"><span>SKIN</span><strong>YOUR<br/>MOMENT</strong></div></div></section>
