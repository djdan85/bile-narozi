...
<section className="lux-hero"><div className="lux-hero-copy"><p className="lux-kicker">Pedikúra · Plzeň</p><h1>Lehký krok.<br/><em>Pěstěný detail.</em></h1><p>Komplexní péče o chodidla zaměřená na pohodlí, zdravý vzhled a příjemný pocit po každé návštěvě.</p><div className="lux-actions"><a className="lux-btn primary" href="#objednani">Objednat se</a><a className="lux-btn secondary" href="tel:+420774536824">Zavolat pedikérce</a></div></div><div className="lux-visual" aria-hidden="true"><div className="visual-glow"/><div className="visual-frame"><span>CARE</span><strong>LIGHT<br/>STEP</strong></div></div></section>
